    ...
    <Box p={5}>
      ...
      <Table variant="simple" mb={6}>
        <Tbody>
          <Tr>
            ...
            <Td width="60%">{data.corpLegalFedTaxId || null}</Td>
          </Tr>
          <Tr>
            <Th color="blue.500" width="40%">
              Years in Business:
      ...
      <Table variant="simple" mb={6}>
        <Tbody>
          <Tr>
            <Th color="blue.500" width="40%">
              Same Information as Legal:
            </Th>
            <Td width="60%">{data.controllerOfficerIsOwner}</Td>
          </Tr>
          <Tr>
            <Th color="blue.500" width="40%">
              DBA Name / Location Name:
            </Th>
      ...
      <Table variant="simple" mb={6}>
        <Tbody>
          <Tr>
            <Th color="blue.500" width="40%">
              Has the controlling officer already been entered as one of the
              owners?:
            </Th>
      ...
      <Table variant="simple" mb={6}>
        <Tbody>
          ...
          <Tr>
            <Th color="blue.500" width="40%">
              Are you accepting today VISA, MASTERCARD, DISCOVER, AMEX for
              payments?:
            </Th>
