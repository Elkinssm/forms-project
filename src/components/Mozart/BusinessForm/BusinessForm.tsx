      ...
      <Box as="form" onSubmit={handleSubmit(onSubmit)} ref={formRef}>
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6}>
          ...
          <FormControl mb={4} isInvalid={!!errors.businessCustomerServicePhone}>
            ...
            />
            <ErrorMessage
              error={errors.businessCustomerServicePhone?.message}
            />
          </FormControl>
          <FormControl mb={4} isInvalid={!!errors.businessCustomerServiceEmail}>
            ...
            />
            <ErrorMessage
              error={errors.businessCustomerServiceEmail?.message}
            />
          </FormControl>
         ...
         "socialMediaAccounts": [
        {
          ...
          <FormControl
            mb={4}
            isInvalid={!!errors.businessEmailAddressForNotices}
          >
          ...
          >
            ...
            <VStack spacing={4} align="center">
              ...
              <ErrorMessage
                error={
                  errors.businessDetailsDocumentsRegistrationCertificate
                    ?.message
                }
              />
            </VStack>
