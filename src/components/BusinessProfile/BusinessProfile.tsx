...
const schema = z.object({
    businessProfileOwnershipType: z.string().min(2, "The Ownership type must be at least 2 chars"),
    businessProfileBusinessType: z.string().min(2, "The Business type must be at least 2 chars"),
    businessProfileMCC: z.string().min(2, "The MCC must be at least 2 chars"),
    businessProfileGoodsServices: z.string().min(2, "The Goods Services must be at least 2 chars"),
    businessProfileBankName: z.string().min(2, "The Bank Name must be at least 2 chars"),
    businessProfileBusinessCheckingAccount: z.string().min(2, "The Business Checking Account must be at least 2 chars"),
    businessProfileBusinessCheckRouting: z.string().min(2, "The Business Check Routing must be at least 2 chars"),
        ...
        <Box as="form" onSubmit={handleSubmit(onSubmit)} ref={formRef}>
            ...
            <FormControl mb={4} isInvalid={!!errors.businessProfileOwnershipType}>
                ...
                {errors.businessProfileOwnershipType && (
                    <Text color="semantic.error.DEFAULT">{errors.businessProfileOwnershipType.message}</Text>
                )}
            </FormControl>

            <FormControl mb={4} isInvalid={!!errors.businessProfileBusinessType}>
                <FormLabel htmlFor="businessProfileBusinessType">Type of Business</FormLabel>
                <Input
                ...
                {errors.businessProfileBusinessType && (
                    <Text color="semantic.error.DEFAULT">{errors.businessProfileBusinessType.message}</Text>
                )}
            </FormControl>
            ...
            <FormControl mb={4} isInvalid={!!errors.businessProfileGoodsServices}>
                ...
                {errors.businessProfileGoodsServices && (
                    <Text color="semantic.error.DEFAULT">{errors.businessProfileGoodsServices.message}</Text>
                )}
            </FormControl>
            ...
            <FormControl mb={4} isInvalid={!!errors.businessProfileBusinessCheckingAccount}>
                <FormLabel htmlFor="businessProfileBusinessCheckingAccount">Business Checking Account</FormLabel>
                <Input
